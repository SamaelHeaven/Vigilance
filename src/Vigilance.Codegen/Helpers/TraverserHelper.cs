        ...
        sb.AppendLine(
            $$"""
                extension({{element}} element)
                {
                    ...
                    {
                        return element.AsTraverser().DescendantsPreOrder();
                    }
                    ...
                    public ZLinq.ValueEnumerable<Vigilance.Collections.DescendantsPostOrder<{{traverser}}, {{element}}>, {{element}}> DescendantsPostOrder()
                    {
                        return element.AsTraverser().DescendantsPostOrder();
                    }
                    
                    public ZLinq.ValueEnumerable<Vigilance.Collections.DescendantsPostOrder<{{traverser}}, {{element}}>, {{element}}> DescendantsPostOrderAndSelf()
                    {
                        return element.AsTraverser().DescendantsPostOrderAndSelf();
                    }
                    
                    public ZLinq.ValueEnumerable<Vigilance.Collections.DescendantsLevelOrder<{{traverser}}, {{element}}>, {{element}}> DescendantsLevelOrder()
                    {
                        return element.AsTraverser().DescendantsLevelOrder();
                    }
                    
                    public ZLinq.ValueEnumerable<Vigilance.Collections.DescendantsLevelOrder<{{traverser}}, {{element}}>, {{element}}> DescendantsLevelOrderAndSelf()
                    {
                        return element.AsTraverser().DescendantsLevelOrderAndSelf();
                    }
                ...
                extension({{traverser}} traverser)
                {
                    ...
                    public ZLinq.ValueEnumerable<ZLinq.Traversables.Descendants<{{traverser}}, {{element}}>, {{element}}> DescendantsPreOrder()
                    {
                        return Vigilance.Collections.ZLinqExtensions.DescendantsPreOrder<{{traverser}}, {{element}}>(traverser);
                    }

                    public ZLinq.ValueEnumerable<ZLinq.Traversables.Descendants<{{traverser}}, {{element}}>, {{element}}> DescendantsPreOrderAndSelf()
                    {
                        return Vigilance.Collections.ZLinqExtensions.DescendantsPreOrderAndSelf<{{traverser}}, {{element}}>(traverser);
                    }
                    
                    public ZLinq.ValueEnumerable<Vigilance.Collections.DescendantsPostOrder<{{traverser}}, {{element}}>, {{element}}> DescendantsPostOrder()
                    {
                        return Vigilance.Collections.ZLinqExtensions.DescendantsPostOrder<{{traverser}}, {{element}}>(traverser);
                    }
                  
                    public ZLinq.ValueEnumerable<Vigilance.Collections.DescendantsPostOrder<{{traverser}}, {{element}}>, {{element}}> DescendantsPostOrderAndSelf()
                    {
                        return Vigilance.Collections.ZLinqExtensions.DescendantsPostOrderAndSelf<{{traverser}}, {{element}}>(traverser);
                    }
                    
                    public ZLinq.ValueEnumerable<Vigilance.Collections.DescendantsLevelOrder<{{traverser}}, {{element}}>, {{element}}> DescendantsLevelOrder()
                    {
                        return Vigilance.Collections.ZLinqExtensions.DescendantsLevelOrder<{{traverser}}, {{element}}>(traverser);
                    }
                    
                    public ZLinq.ValueEnumerable<Vigilance.Collections.DescendantsLevelOrder<{{traverser}}, {{element}}>, {{element}}> DescendantsLevelOrderAndSelf()
                    {
                        return Vigilance.Collections.ZLinqExtensions.DescendantsLevelOrderAndSelf<{{traverser}}, {{element}}>(traverser);
                    }
